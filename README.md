...
Evaluate the hamishrickerby.clj-euler namespace and a mulog publisher will start, sending pretty printed events to the console. Evaluate `(mulog-publisher)` to stop the mulog publisher.
...
Copyright © 2024 Hamish Rickerby
